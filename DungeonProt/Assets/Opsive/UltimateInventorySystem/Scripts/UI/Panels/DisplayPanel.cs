...
namespace Opsive.UltimateInventorySystem.UI.Panels
{
    ...
    public struct OpenClosePanelInfo
    {
        public bool Open;
    ...
    public class DisplayPanel : MonoBehaviour
    {
        ...
        public virtual void OpenBack()
        {
            ...
            if (m_Manager != null) {
                EventHandler.ExecuteEvent<OpenClosePanelInfo>(m_Manager.PanelOwner, EventNames.c_GameObject_OnPanelOpenClose_OpenClosePanelInfo, 
                    new OpenClosePanelInfo()
                    {
                        Open = true,
                        OpenBack = true,
