...
namespace Opsive.UltimateInventorySystem.Crafting
{
    ...
    public abstract class CraftingProcessor
    {
        ...
        public bool CanCraft(CraftingRecipe recipe, IInventory inventory, int quantity = 1)
        {
            ...
            if (result) {
                result = CanCraftInternal(recipe, inventory, quantity, selectedIngredients);
            }
            ...
            int quantity = 1)
        {
            ...
            return CanCraftInternal(recipe, inventory, quantity, selectedIngredients);
        }
        ...
        /// <param name="selectedIngredients">The item infos selected.</param>
        /// <returns>True if you can craft.</returns>
        protected abstract bool CanCraftInternal(CraftingRecipe recipe, IInventory inventory, int quantity,
        ...
        public CraftingResult Craft(CraftingRecipe recipe, IInventory inventory, int quantity = 1)
        {
            ...
            var result = CraftInternal(recipe, inventory, quantity, selectedIngredients);
        ...
        public CraftingResult Craft(CraftingRecipe recipe, IInventory inventory, ListSlice<ItemInfo> selectedIngredients,
            int quantity = 1)
        {
            if (selectedIngredients.IsNull) { return new CraftingResult(null, false); }
            return CraftInternal(recipe, inventory, quantity, selectedIngredients);
        }
        ...
        /// <param name="selectedIngredients">The item infos selected.</param>
        /// <returns>True if you can craft.</returns>
        protected abstract CraftingResult CraftInternal(CraftingRecipe recipe, IInventory inventory, int quantity,
            ListSlice<ItemInfo> selectedIngredients);
    }
}