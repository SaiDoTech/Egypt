namespace Opsive.UltimateInventorySystem.Editor.Managers.UIDesigner
{
    ...
    public class ItemDescriptionDesignerCreator : UIDesignerCreator<ItemDescriptionBase>
    {
        ...
        protected override ItemDescriptionBase BuildInternal()
        {
            ...
            if (m_UsePanel.value) {
                binding = CreatePanelWithDescriptionBinding(rectParent);
        ...
        protected ItemDescriptionPanelBinding CreatePanelWithDescriptionBinding(RectTransform panelParent)
        {
    ...
    public class ItemViewSlotsContainerItemDescriptionOption : ItemDescriptionOption
    {
        ...
        protected Button m_BindUnBindButton;
        protected Button m_ConvertToTooltipButton;
        ...
        public ItemViewSlotsContainerItemDescriptionOption(ItemDescriptionDesignerEditor itemDescriptionDesignerEditor) : base(itemDescriptionDesignerEditor)
        {
            ...
            m_BindUnBindButton = new Button();
            m_BindUnBindButton.clicked += BindUnBind;
            
            m_ConvertToTooltipButton = new Button();
            m_ConvertToTooltipButton.clicked += ConvertToTooltip;
        }
        ...
        private void HandleValidItemViewSlotsContainer()
        {
            ...
            m_BindUnBindButton.text = binding != null ? "Unbind" : "Bind";

            m_ItemViewSlotsVisualContainer.Add(m_BindUnBindButton);
            ...
            m_ConvertToTooltipButton.text = panelToTooltip != null ? "Revert From Tooltip" : "Convert To Tooltip";
